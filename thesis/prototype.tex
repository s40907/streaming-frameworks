...
\begin{axis}[ enlarge x limits=0.03, 
							...
							width=1\linewidth,
							height=10cm,
							legend entries = {Apache Storm, Apache Kafka, Apache Flume, Apache S4, Raw},
...
\addplot+ table [x=Time, y=Mps, col sep=comma,trim cells=true] {anhangMessung/traversedMeasureRaw.dat};
\end{axis} 
\end{tikzpicture}
