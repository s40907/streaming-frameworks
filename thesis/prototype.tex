...
\begin{axis}[ enlarge x limits=0.03, 
							...
							width=1\linewidth,
							height=10cm,
							legend entries = {Apache Storm, Apache Storm WG1, Apache Storm WG2, Apache Storm Raw Bolt},
...
%\addplot+ table [x=Time, y=Mps, col sep=comma,trim cells=true] {anhangMessung/traversedMeasureStormWG2.dat};
\addplot+ table [x=Time, y=Mps, col sep=comma,trim cells=true] {anhangMessung/traversedMeasureStormRawBolt.dat};
\end{axis} 
\end{tikzpicture}
